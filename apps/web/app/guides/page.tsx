...
const Guides = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      {/* SEO Meta */}
      <title>User Guides - roomkarts | How to List and Find Properties</title>

      {/* Header */}
      <div className="bg-muted/30 py-8 sm:py-10 md:py-12">
        <div className="container mx-auto px-4 sm:px-6 md:px-8 text-center">
          <Badge className="trust-badge mb-3 sm:mb-4">Step-by-Step Guides</Badge>
          <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-3 sm:mb-4">How roomkarts Works</h1>
      ...
      <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-12 py-8 sm:py-10 md:py-12 space-y-10 sm:space-y-12">
        {/* Seeker Guide - Show for users or if not logged in */}
        {(!user || isUser) && (
        <section id="user-guide">
          <div className="mb-4 sm:mb-6 flex items-center justify-between flex-col sm:flex-row gap-3">
            <h2 className="text-xl sm:text-2xl font-bold">For Renters/Seekers</h2>
            <Link href="/properties">
              <Button className="btn-hero w-full sm:w-auto">Start Exploring</Button>
            </Link>
          </div>
        ...
        {/* Owner Guide - Show for owners or if not logged in */}
        {(!user || isOwner) && (
        <section id="owner-guide">
          <div className="mb-4 sm:mb-6 flex items-center justify-between flex-col sm:flex-row gap-3">
            <h2 className="text-xl sm:text-2xl font-bold">For Property Owners</h2>
            <Link href="/properties">
              <Button variant="outline" className="px-6 w-full sm:w-auto">List Your Property</Button>
            </Link>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
        ...
        {/* FAQ / Tips */}
        <section>
          <h2 className="text-xl sm:text-2xl font-bold mb-4">Tips</h2>
          <div className="grid md:grid-cols-2 gap-4">
            <Card>
              <CardContent className="p-4 sm:p-6 space-y-2">
                <h3 className="font-semibold text-base sm:text-lg">For Renters</h3>
            ...
            <Card>
              <CardContent className="p-4 sm:p-6 space-y-2">
                <h3 className="font-semibold text-base sm:text-lg">For Owners</h3>
                <ul className="list-disc pl-5 text-xs sm:text-sm text-muted-foreground space-y-1">
